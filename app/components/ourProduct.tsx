        ...
        {products.map((product) => (
          <div key={product.id} className="group relative rounded-lg bg-white">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <Link href={"/contact"}> {/* Redirect to Contact page */}
                <button className="rounded-full bg-[#00B5A5] p-2 text-white transition-colors hover:bg-[#00A294]">
                  <ShoppingCart className="h-5 w-5" />
                  <span className="sr-only">Add to cart</span>
                </button>
...
// import Image from "next/image";
// import Link from "next/link";
// import { useRouter } from "next/navigation"; // Corrected import for Next.js App Directory
...
//     // Redirect to the BuyingProduct page when the Add to Cart button is clicked
//     router.push("/buying-product");
//   };
