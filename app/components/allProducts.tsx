        ...
        {products.map((product) => (
          <div key={product.id} className="group relative rounded-lg bg-white">
            <div className="relative aspect-square overflow-hidden rounded-lg">
              ...
              <Link href={"productDectription/discription"}>
                <Image
                  src={product.image}
                  alt={product.title}
                  height={400}
...
//                 </Badge>
//               )}
//               {/* Link updated to navigate to the product detail page */}
//               <Link href={`/buying-product`}>
//                 <Image
//                   src={product.image}
//                   alt={product.title}
//                   height={400}
